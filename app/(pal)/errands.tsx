...
const styles = StyleSheet.create({
    ...
    tabsContainer: { backgroundColor: 'white', borderBottomWidth: 1, borderBottomColor: '#F3F4F6', maxHeight: 52, },
    tabsContent: { paddingHorizontal: 16, paddingVertical: 6, gap: 8, alignItems: 'center' },
