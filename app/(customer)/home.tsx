...
export default function CustomerHome() {
    ...
    const [errandTime, setErrandTime] = useState<Date | null>(null);
    ...
    const handleSubmitErrand = async () => {
        ...
        try {
            ...
            const fullDescription = [
                errandDetails,
                errandTime ? `Preferred Time: ${formatTimeForBackend(errandTime)}` : '',
                ...
                { text: 'Cancel', style: 'cancel' },
                {
                    text: 'Complete', onPress: async () => {
                        try {
                            ...
                            // Immediately refresh so home screen updates
        ...
        <View style={styles.container}>
            ...
            >
                ...
                {activeErrand?.latitude && activeErrand?.longitude && (
                    <Marker
                        coordinate={{ latitude: activeErrand.latitude, longitude: activeErrand.longitude }}
                    ...
                    {!activeErrand ? (
                        <>
                            <View style={styles.requestButtonContainer}>
                                <ImageBackground
                                    source={require('../../assets/images/btn_4.png')}
                                    resizeMode='stretch'
                        ...
                        <>
                            ...
                            {activeErrand.status === 'Matched' && activeErrand.pal && (
                                <View style={styles.palCard}>
                                    ...
                                    <View style={styles.palActions}>
                                        <TouchableOpacity style={styles.declineBtn} onPress={handleDeclinePal}>
                                            <Text style={styles.declineBtnText}>Decline</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity style={styles.acceptBtn} onPress={handleAcceptPal}>
                            ...
                            {activeErrand.status === 'Active' && (
                                <TouchableOpacity style={styles.completeBtn} onPress={handleCompleteErrand}>
                            ...
                            >
                                ...
                                >
                                    {POPULAR_SERVICES.map(service => (
                                        <TouchableOpacity
                                            key={service}
                                            style={[styles.serviceChip, errandCategory === service && styles.serviceChipActive]}
                                            onPress={() => setErrandCategory(errandCategory === service ? '' : service)}
                                        >
                                            <Text style={[styles.serviceChipText, errandCategory === service && styles.serviceChipTextActive]}>
                                                {service}
                                            </Text>
                                        </TouchableOpacity>
                                    ))}
                                ...
                                />
                                <TouchableOpacity style={styles.gpsButton} onPress={handleUseGPS} disabled={usingGPS}>
                                    {usingGPS ? (
                                ...
                                >
                                    <ImageBackground source={require('../../assets/images/input-bg.png')} resizeMode={"stretch"}>
                                        <View style={{
                                            ...
                                            <Text style={{
                                                ...
                                                color: errandTime ? '#111827' : '#9CA3AF',
                                            }}>
                                                {errandTime ? formatTimeForDisplay(errandTime) : 'Select time (e.g. 10:00 AM)'}
                                            </Text>
                                            {/*<Text style={{ fontSize: 16 }}>🕐</Text>*/}
                                            <Image source={require('../../assets/images/clock_icon.png')} style={{
                                                width: 20, height: 20,
                                            }}/>
                    ...
                    {showDurationPicker && (
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={{ fontSize: 16, fontFamily: 'Nunito_700Bold', color: '#111827', paddingLeft: 10 }}>
                                    Estimated Duration
                                </Text>
                                ...
                                {Platform.OS === 'ios' && (
                                    <View style={{
                                        ...
                                        <TouchableOpacity onPress={() => {
                                            ...
                                            <Text style={{ fontSize: 14, fontFamily: 'Nunito_600SemiBold', color: '#6B7280' }}>Clear</Text>
                                        </TouchableOpacity>
                                        <Text style={{ fontSize: 16, fontFamily: 'Nunito_700Bold', color: '#111827' }}>Choose Time</Text>
                                        <TouchableOpacity onPress={() => setShowTimePicker(false)}>
                                            <Text style={{ fontSize: 14, fontFamily: 'Nunito_700Bold', color: '#2563EB' }}>Done</Text>
                                        </TouchableOpacity>
                                    </View>
                                )}
                                <DateTimePicker
                                    value={errandTime || new Date()}
                                    mode="time"
                                    display="spinner"
                                    onChange={(_, date) => {
                                        if (date) setErrandTime(date);
            ...
            <Modal visible={showSuccess} animationType="fade" transparent>
                <View style={styles.successOverlay}>
                    <View style={styles.successCard}>
                        ...
                        <Image source={require('../../assets/images/success_icon_1.png')} style={{ width: 100, height: 100 }} />
                        ...
                        <View style={styles.successButton}>
                            <CustomButton title="Dismiss" onPress={() => setShowSuccess(false)} />
                        </View>
                    </View>
                </View>
            </Modal>
...
const styles = StyleSheet.create({
    ...
    profilePic: {
        width: 59, height: 59, borderRadius: 23, overflow: 'hidden',
        shadowColor: '#ffffff', shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.15, shadowRadius: 4, elevation: 4,
    },
    ProfilePicBG: { width: 59, height: 59, alignItems: 'center', justifyContent: 'center' },
    ProfileCircle: {
        backgroundColor: '#FFFFFF', width: 30, height: 30, borderRadius: 15,
    ...
    profileInitial: { fontSize: 14, fontFamily: 'Nunito_700Bold', color: 'white' },
    notificationBtn: {
        width: 59, height: 59, borderRadius: 23, alignItems: 'center',
        justifyContent: 'center', elevation: 4,
    },
    notificationIcon: { width: 59, height: 59 },
    bottomSheet: {
        position: 'absolute', bottom: 0, left: 0, right: 0,
        backgroundColor: '#EBF1FF', borderTopLeftRadius: 40, borderTopRightRadius: 40,
        shadowColor: '#000', shadowOffset: { width: 0, height: -4 },
        shadowOpacity: 0.3, shadowRadius: 4, elevation: 10,
        paddingHorizontal: 20, paddingBottom: 0,
    },
    dragArea: { paddingVertical: 12, alignItems: 'center' },
    handle: { width: 50, height: 4, backgroundColor: '#10B981', borderRadius: 2 },
    requestButtonContainer: { alignItems: 'center', marginTop: 10 },
    requestButtonBG: { justifyContent: 'center', marginBottom: 20, width: 266, height: 44 },
    requestButton: { borderRadius: 16, paddingVertical: 8, alignItems: 'center' },
    requestButtonText: { fontSize: 16, fontFamily: 'Nunito_700Bold', color: 'white' },
    sectionTitle: { fontSize: 14, fontFamily: 'Nunito_700Bold', color: '#111827', marginBottom: 12 },
    serviceChip: {
    ...
    serviceChipText: { fontSize: 12, fontFamily: 'Nunito_600SemiBold', color: '#FFFFFF' },
    serviceChipTextActive: { color: 'white' },
    recentErrandCard: {
        flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9FAFB',
        borderRadius: 50, paddingVertical: 7, paddingHorizontal: 20, marginBottom: 8,
    },
    recentErrandTitle: { fontSize: 13, fontFamily: 'Nunito_600SemiBold', color: '#111827' },
    recentErrandDate: { fontSize: 11, fontFamily: 'Nunito_400Regular', color: '#6B7280', marginTop: 2 },
    recentErrandPrice: { fontSize: 13, fontFamily: 'Nunito_700Bold', color: '#111827' },
    recentErrandArrow: { fontSize: 18, color: '#9CA3AF' },
    statusBanner: {
        borderLeftWidth: 4, backgroundColor: '#F9FAFB',
        borderRadius: 8, padding: 12, marginBottom: 12,
    },
    statusBannerText: { fontSize: 13, fontFamily: 'Nunito_600SemiBold', color: '#374151' },
    activeErrandCard: {
        backgroundColor: '#F9FAFB', borderRadius: 16, padding: 16, marginBottom: 12, gap: 6,
    },
    activeErrandTitle: { fontSize: 15, fontFamily: 'Nunito_700Bold', color: '#111827', marginBottom: 4 },
    activeErrandRowDetail: { flexDirection: 'row', gap: 10, alignItems: 'center' },
    activeErrandDetail: { fontSize: 12, fontFamily: 'Nunito_500Medium', color: '#6B7280' },
    statusBadge: { alignSelf: 'flex-start', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4, marginTop: 8 },
    statusBadgeText: { fontSize: 11, fontFamily: 'Nunito_700Bold', color: 'white' },
    palCard: { backgroundColor: '#EFF6FF', borderRadius: 16, padding: 16, marginBottom: 12 },
    palCardTitle: {
        fontSize: 14, fontFamily: 'Nunito_600SemiBold', color: '#1E40AF',
    ...
    declineBtnText: { fontSize: 14, fontFamily: 'Nunito_600SemiBold', color: '#EF4444' },
    acceptBtn: { flex: 1, backgroundColor: '#10B981', borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
    acceptBtnText: { fontSize: 14, fontFamily: 'Nunito_700Bold', color: 'white' },
    completeBtn: { backgroundColor: '#10B981', borderRadius: 16, paddingVertical: 16, alignItems: 'center' },
    completeBtnText: { fontSize: 15, fontFamily: 'Nunito_700Bold', color: 'white' },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.4)' },
    formSheetContainer: { backgroundColor: 'rgba(0,0,0,0.4)' },
    formSheet: {
        backgroundColor: '#EBF1FF', borderTopLeftRadius: 40,
        borderTopRightRadius: 40, maxHeight: height * 0.90,
    },
    formTitle: {
        fontSize: 20, fontFamily: 'Nunito_700Bold', color: '#111827',
        marginBottom: 4, marginTop: 0, marginLeft: 20,
    },
    formSubtitle: { fontSize: 12, fontFamily: 'Nunito_500Medium', color: '#6B7280', marginBottom: 20 },
    fieldLabel: { fontSize: 12, fontFamily: 'Nunito_600SemiBold', color: '#374151', marginBottom: 8 },
    textAreaWrapper: {
        paddingHorizontal: 24, height: 88, marginBottom: 16,
        paddingVertical: Platform.OS === 'ios' ? 5 : 0,
    },
    textArea: { fontSize: 12, fontFamily: 'Nunito_500Medium', color: '#111827', textAlignVertical: 'top' },
    gpsButton: { alignItems: 'center', justifyContent: 'center', marginTop: -8, marginBottom: 16, paddingVertical: 8 },
    gpsButtonText: { fontSize: 12, fontFamily: 'Nunito_600SemiBold', color: '#2563EB' },
    successOverlay: {
        flex: 1,
    ...
    successCard: {
        backgroundColor: COLORS.background, paddingHorizontal: 32, paddingTop: Platform.OS === 'ios' ? 150 : 120,
        alignItems: 'center',
        width: '100%', gap: 12, height: '100%'
    },
    successTitle: { fontSize: 30, fontFamily: 'Nunito_800ExtraBold', color: COLORS.secondary },
    successMessage: {
